      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right" style="top: 10px";>
            <a target="_blank" href="export_tidak_absensi_siswa.php" class="btn btn-success btn-sm" style="background-color: var(--color-secondary-green); border: none;">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
              ...
              <?php
                ...
                // 2. Buat Kueri Basis
                // Kueri ini MENGGABUNGKAN 'ijin_siswa' (i) dengan 'siswa' (e)
                $base_sql = "
                  FROM ijin_siswa i
