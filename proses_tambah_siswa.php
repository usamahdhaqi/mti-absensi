...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Ganti Kueri
    $sql = "INSERT INTO siswa (nis, nama_siswa, email, no_hp, kelas, jurusan, id_telegram) 
            VALUES ('$nis', '$nama_siswa', '$email', '$no_hp', '$kelas', '$jurusan', '$id_telegram')";

    if (mysqli_query($con, $sql)) {
        tampilkan_pesan('sukses', 'Berhasil', "Siswa '$nama_siswa' berhasil ditambahkan.");
    } else {
