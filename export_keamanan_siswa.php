...
<html>
<head>
	<title>Export Data Log Keamanan Siswa Ke Excel</title>
	<style type="text/css">
...
<body>
	<left><h1>Data Log Keamanan Siswa Metro Teknologi Informatika</h1></left>
	<table border="1">
		<tr>
      <th>No</th>
    ...
    $sql_export = "SELECT * FROM log_keamanan_siswa
                   WHERE 1=1 " 
                   . $tanggal_dari_filter_sql 
                   . $tanggal_sampai_filter_sql 
