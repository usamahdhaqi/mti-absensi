...
<head>
  ...
  <title>MTI Absensi | Data Tidak Absen</title>
 ...
 ?>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Data Tidak Absensi
        <small>Karyawan yang tidak absen (alpha)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tidak Absensi</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-table"></i> Data Tidak Absensi</h3>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                  ...
                  <?php
                   ...
                   // Base query
                   $base_sql = "FROM `not_absensi` JOIN employee ON not_absensi.nama_pegawai=employee.nama_pegawai WHERE 1 ";
                   ...
                   if (isset($_SESSION['from']) && strlen($_SESSION['from'])>5) {
                     ...
                     $base_sql .= "AND DATE(not_absensi.tanggal_absen)>= '$dt1' " ;
                   }

                   if (isset($_SESSION['to']) && strlen($_SESSION['to'])>5) {
                     $date = new DateTime($_SESSION['to']);
                     $dt2=$date->format('Y-m-d'); // To match MySQL date format
                     // CATATAN PENTING: Query Anda salah, menggunakan 'waktu_masuk' padahal tabelnya 'not_absensi'. 
                     // Saya ganti ke 'tanggal_absen'
                     $base_sql .= "AND DATE(not_absensi.tanggal_absen)<= '$dt2' " ; 
                   }
                   ...
                   $sqlemp .= "ORDER BY not_absensi.tanggal_absen DESC ";
